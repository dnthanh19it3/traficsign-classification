...
classLabels = ['Toc do toi da cho phep 5 km/h', 'Toc do toi da cho phep 15 km/h', 'Cam di thang', 'Cam re trai',
               'Cam re trai va re phai', 'Cam re phai', 'Cam vuot', 'Cam quay dau xe',
               'Cam xe o to', 'Cam bop coi', 'Het han che toc do toi da 40km/h', 'Het han che toc do toi da 50km/h',
...
for (startX, startY, endX, endY) in boxIdxs:
	...
	cropedImg = cv2.resize(image[startY:endY, startX:endX], (32, 32))
	cv2.imshow(cropedImg)
	...
	cv2.putText(image, "tfsign [{}]".format(classLabels[preds[i]]), (startX, y),cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 1)
	
    

cv2.imshow("Object Detection", image)
roi = image[startY:endY, startX:endX]
cv2.imshow("Object Cropped", roi)
