...
BASE_PATH = "dataset"
POSITVE_PATH = os.path.sep.join([BASE_PATH, "tfsign"])
NEGATIVE_PATH = os.path.sep.join([BASE_PATH, "no_tfsign"])
...
MODEL_PATH = "tfsign_detector.h5"
ENCODER_PATH = "tfsign_label_encoder.pickle"
